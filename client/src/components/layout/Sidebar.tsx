            ...
            item.children ? (
              <div key={item.label} className="mb-2">
                <button
                  ...
                  className="w-full flex items-center justify-between gap-3 p-3 rounded-xl text-gray-700 hover:bg-purple-50 hover:text-purple-700 transition-all duration-200 font-medium"
                >
                  <div className="flex items-center gap-3">
                ...
                >
                  {item.children.map((child) => (
                    ...
                    >
                      <span className={`${isActive(child.href) ? 'text-purple-600' : 'text-gray-500'}`}>
                        {child.icon}
                      </span>
              ...
              >
                <span className={`${isActive(item.href) ? 'text-purple-600' : 'text-purple-500'}`}>
                  {item.icon}
                </span>
                <span>{item.label}</span>
                {isActive(item.href) && (
